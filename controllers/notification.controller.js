...
exports.search = async (req, res) => {
    try {
        ...
        activity_handler.record_activity(req.user, 'notification.search', req, res, 'Notification');
        response_handler.set_success_response(res, req, 200, 'Notifications retrieved successfully!', {
            entities: entities
        });
    } catch (error) {
        activity_handler.record_activity(req.user, 'notification.search', req, res, 'Notification', error);
        response_handler.handle_error(error, res, req);
    }
};
